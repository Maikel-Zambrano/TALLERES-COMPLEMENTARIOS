window.addEventListener('load', function(){
    ...
    btngrabar.addEventListener('click', function(){
        let url=`http://localhost:8080/v1/pruebas/api/productos`;
        let data = {
    ...
    btnmodificar.addEventListener('click', function(){
        let url=`http://localhost:8080/v1/pruebas/api/productos/${txtid.value}`;
        let data = {
            nombre: txtnombre.value ,
            costo: txtcosto.value ,
            precio: txtprecio.value,
        ...
        .then(consulta=>{
            ...
            document.querySelectorAll('.actualizar').forEach(e=>{
                e.addEventListener('click', ()=>{
                    let url2=`http://localhost:8080/v1/pruebas/api/productos/${e.value}`;
